...
describe('DataManager', () => {
  ...
  it('shows success message after successful import', async () => {
    ...
    vi.spyOn(storage, 'importAllData').mockReturnValue({
      ...
      importedCounts: { session: 0, mistakes: 0, history: 1, xpProfile: 0, dailyChallenges: 0, badgeProgress: 0, badges: 0, personalWords: 0, personalDictionary: 0, churnMetrics: 0 },
    });

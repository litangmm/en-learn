...
// ============================================================================
// Smart Practice Recommendation Types (epic-083 iter-002)
// ============================================================================

/**
 * Types of practice recommendations.
 * - 'high-error': User has high error rate on this sentence (3+ wrong answers)
 * - 'low-accuracy': User's accuracy on this sentence is below threshold
 * - 'neglected-review': User has not reviewed this sentence for a long time (7+ days)
 * - 'new-word': Personal word not yet practiced
 * - 'mode-weak': User is weak in a specific practice mode (< 50% accuracy)
 */
export type RecommendationType = 'high-error' | 'low-accuracy' | 'neglected-review' | 'new-word' | 'mode-weak';

/**
 * A practice recommendation for the user.
 * Generated by the recommendation algorithm to guide practice sessions.
 */
export interface PracticeRecommendation {
  /** Unique identifier for this recommendation */
  id: string;
  /** The type/category of recommendation */
  type: RecommendationType;
  /** Priority level (1 = highest priority, 3 = lowest) */
  priority: 1 | 2 | 3;
  /** Chinese explanation why this is recommended */
  reason: string;
  /** The sentence ID to practice */
  targetSentenceId: string;
  /** Optional sentence data for display purposes */
  targetSentence?: Sentence;
  /** Recommended action text in Chinese */
  action: string;
  /** Optional practice mode hint for focused practice */
...
export const RECOMMENDATION_THRESHOLDS = {
  /** Minimum wrong answers to trigger high-error recommendation */
  highErrorCount: 3,
  /** Days without review to trigger neglected-review recommendation */
  neglectedReviewDays: 7,
  /** Accuracy threshold for mode-weak recommendation (below this = weak) */
  modeWeakAccuracy: 50,
} as const;

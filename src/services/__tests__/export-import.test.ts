...
describe('StorageService Export/Import', () => {
  ...
  describe('importAllData', () => {
    ...
    it('handles empty data gracefully', () => {
      ...
      expect(result.importedCounts).toEqual({ session: 0, mistakes: 0, history: 0, xpProfile: 0, dailyChallenges: 0, badgeProgress: 0, badges: 0, personalWords: 0, personalDictionary: 0 });
    });
